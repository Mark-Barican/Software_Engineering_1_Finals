// MongoDB Import Script for Library Application
...
// 2. Create Books Collection (matching your UI book data)
db.books.insertMany([
  {
...
print("Books created: " + db.books.countDocuments());
print("");
print("Default password for all users: 'password123'");
print("Test user emails:");
print("  - john.doe@example.com");
print("  - jane.smith@university.edu");
print("  - student@jdlcitech.ph");
print("  - mary.johnson@library.org");
print("");
print("Your library application is ready to use!"); 